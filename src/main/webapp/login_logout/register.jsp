                        ...
                        <div class="col-md-6 col-lg-7 d-flex align-items-center">
                            <div class="card-body p-4 p-lg-5 text-black">
                                <form action="/sessionController" method="post">
                                    ...
                                    <h5 class="fw-normal mb-3 pb-3" style="letter-spacing: 1px;">Create an account for you</h5>

                                    <div class="form-outline mb-4">
                                        <input type="text" required name="userName" id="form2Example17"
                                    ...
                                    <p class="mb-5 pb-lg-2" style="color: #393f81;">Already have an account?
                                        <a href="/login_logout/login.jsp" style="color: #393f81;">Login here</a></p>
                                </form>
                            </div>
                        </div>
                    </div>
